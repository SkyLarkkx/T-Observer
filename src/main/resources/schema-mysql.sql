alter table org_teaching_group
    modify column id bigint unsigned not null auto_increment comment '自增主键',
    modify column group_code varchar(32) not null comment '教研组编码',
    modify column group_name varchar(64) not null comment '教研组名称',
    modify column subject_code varchar(32) not null comment '学科编码',
...
alter table org_teaching_group_member
    modify column id bigint unsigned not null auto_increment comment '自增主键',
    modify column group_id bigint unsigned not null comment '教研组ID',
    modify column user_id bigint unsigned not null comment '用户ID',
    modify column group_role_code varchar(16) not null comment '组内岗位编码',
    modify column create_time datetime not null default current_timestamp comment '创建时间',
    modify column update_time datetime not null default current_timestamp on update current_timestamp comment '更新时间',
    engine=InnoDB,
    default character set utf8mb4,
